...
import (
	...
	"somsing/backend/auth"
	"somsing/backend/catalog"
	"somsing/backend/customers"
	"somsing/backend/dashboard"
	"somsing/backend/db"
	"somsing/backend/finance"
	"somsing/backend/hr"
	"somsing/backend/inbound"
	"somsing/backend/internal/handler"
	"somsing/backend/inventory"
	"somsing/backend/middleware"
	"somsing/backend/notifications"
	"somsing/backend/orders"
	"somsing/backend/preflight"
	"somsing/backend/pricing"
	"somsing/backend/settings"
	"somsing/backend/spoilage"
	"somsing/backend/suppliers"
