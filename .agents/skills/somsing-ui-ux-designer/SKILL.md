...
5. **การกำหนดสเปกข้อมูลหน้าจอ (Screen Data Inventory & Information Architecture):** เมื่อพบปัญหาข้อมูลบนหน้าจอไม่ครบ (เช่น แดชบอร์ดเครื่องจักร/เครื่องพิมพ์) ต้องทำรายการฟิลด์ข้อมูลที่ต้องแสดง (Data Field Inventory) และวาง Layout สรุปลงใน Task File ก่อนส่งให้ Frontend เขียนโค้ดเสมอ
