 ...
 * @param {Object} opts
 * @param {string} opts.target — PromptPay target, digits only (phone 10 digits / ID 13 digits)
 * @param {number} opts.amount — amount in THB
 * @param {string} [opts.billRef] — bill/reference number (order id)
 */
export function buildPromptPayPayload({ target, amount, billRef }) {
