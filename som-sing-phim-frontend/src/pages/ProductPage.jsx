...
import { getCategory, getProduct } from '../data/catalog.js'
import { useShop } from '../context/ShopContext.jsx'
import { computePrice, getQuantityTier } from '../utils/pricing.js'
...
function SpecGroup({ title, hint, options, value, onChange }) {
  return (
